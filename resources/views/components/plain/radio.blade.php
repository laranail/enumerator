@php
    ...
    $classes       = $overrideClasses       ?? 'enumerator-radio-group';
    $itemClasses   = $overrideItemClasses   ?? 'enumerator-radio-item';
    $inputClasses  = $overrideInputClasses  ?? '';
    $labelClasses  = $overrideLabelClasses  ?? 'enumerator-radio-label';
    $legendClasses = $overrideLegendClasses ?? 'enumerator-radio-legend';
