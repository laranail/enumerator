@php
    ...
    $classes       = $overrideClasses       ?? 'enumerator-checkbox-group';
    $itemClasses   = $overrideItemClasses   ?? 'enumerator-checkbox-item';
    $inputClasses  = $overrideInputClasses  ?? '';
    $labelClasses  = $overrideLabelClasses  ?? 'enumerator-checkbox-label';
    $legendClasses = $overrideLegendClasses ?? 'enumerator-checkbox-legend';
